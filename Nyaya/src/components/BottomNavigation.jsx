...
export default function BottomNavigation() {
    ...
    return (
        <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-theme-bottom-nav glass-nav border-t border-theme-border shadow-[0_-2px_10px_rgba(0,0,0,0.08)]">
